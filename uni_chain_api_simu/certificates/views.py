...
from wallets.models import Wallet, WalletTransactions, PayTokens
from .models import CertificateFeesSettings, CertificateViewRequests, Documents
from .serializers import DocumentRequestVerificationSerializer, DocumentUploadSerializer, AddressSerializer, CertificateUploadSerializer
from wallets.serializers import EscrowTransactionsSerializer, EscrowTransactionDetailSerializer, DocumentVerificationRequestSerializer, WalletTransactionsSerializer, DocumentVerificationRequestDataSerializer
...
class VerifiedCertificateUpload(APIView):
    ...
    def post(self, request):
        ...
        if certificate.is_valid():
            ...
            data_dict = {"status":200, "data":certificate.data}
            return Response(data_dict, status=status.HTTP_200_OK)
