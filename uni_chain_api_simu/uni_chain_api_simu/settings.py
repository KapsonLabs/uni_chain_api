"""
Django settings for uni_chain_api_simu project.
...
SECRET_KEY = '_bc8!_b=e12=^#np)!8y(y8=&@jk3xgyu39%-k^)lbcgr&s-d^'
...
ROOT_URLCONF = 'uni_chain_api_simu.urls'
...
WSGI_APPLICATION = 'uni_chain_api_simu.wsgi.application'
